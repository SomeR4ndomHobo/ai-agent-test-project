...
async function loadYaml(file) {
	const content = await read_file_default(file);
	if (!parseYaml) ({__parsePrettierYamlConfig: parseYaml} = await import("./yaml-D9LV99X7.js"));
	try {
...
var init_prettier = __esmMin((() => {
	...
	init_production_plugins = __esm({ "src/main/plugins/builtin-plugins/production-plugins.js"() {
		...
		plugins = /* @__PURE__ */ toLazyLoadPlugins({
			name: "acorn",
			load: () => import("./acorn-CtsFekW8.js"),
			parsers: ["acorn", "espree"]
		}, {
			name: "angular",
			load: () => import("./angular-BMGl4I2b.js"),
			parsers: [
				"__ng_action",
				"__ng_binding",
				"__ng_directive",
			...
			name: "markdown",
			load: () => import("./markdown-ZuiQU4Xe.js"),
			...
			name: "meriyah",
			load: () => import("./meriyah-Bnf5-uoz.js"),
			parsers: ["meriyah"]
		}, {
			name: "postcss",
			load: () => import("./postcss-Beyg94OR.js"),
			...
			name: "typescript",
			load: () => import("./typescript-DPjQlwux.js"),
			parsers: ["typescript"]
		}, {
			name: "yaml",
			load: () => import("./yaml-D9LV99X7.js"),
