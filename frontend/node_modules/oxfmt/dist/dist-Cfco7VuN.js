...
import { n as init_babel, parsers as Aa, t as babel_exports } from "./babel-DOKftyTN.js";
import index_exports, { t as init_prettier } from "./prettier-DQnDZejz.js";
import { a as __toESM$1, t as __commonJSMin } from "./chunk-DSjvVL_1-5TM-HYff.js";
import { a as sortClasses, c as cacheForDirs, d as expiringMap, f as loadIfExists, i as sortClassList, l as spliceChangesIntoString, n as error, o as warn, p as maybeResolve, r as getTailwindConfig$1, u as visit } from "./sorter-BZkvDMjt-D5Z3h2CE.js";
import { parsers as Cn, t as init_angular } from "./angular-BMGl4I2b.js";
import { n as postcss_exports, parsers as cn, t as init_postcss } from "./postcss-Beyg94OR.js";
import * as path from "node:path";
import { isAbsolute } from "path";
//#region ../../node_modules/.pnpm/prettier-plugin-tailwindcss@0.0.0-insiders.2b6f3c2_prettier-plugin-svelte@4.1.1_prettie_f0b30ddf700a5510168a9495d544b49d/node_modules/prettier-plugin-tailwindcss/dist/index.mjs
init_angular();
init_babel();
init_postcss();
init_prettier();
...
const { parsers, printers } = createPlugin([
	defineTransform({
		...
		load: [{
			...
			importer: () => import("./html-BK14XXtm.js")
		}],
	...
	defineTransform({
		...
		load: [{
			...
			importer: () => import("./glimmer-Dxb2wDO_.js")
		}],
		parsers: { glimmer: {} },
	...
	defineTransform({
		...
		parsers: {
			...
			typescript: { load: [{
				...
				importer: () => import("./typescript-DPjQlwux.js")
			}] },
			meriyah: { load: [{
				name: "prettier/plugins/meriyah",
				importer: () => import("./meriyah-Bnf5-uoz.js")
			}] },
			acorn: { load: [{
				name: "prettier/plugins/acorn",
				importer: () => import("./acorn-CtsFekW8.js")
			}] },
			flow: { load: [{
				name: "prettier/plugins/flow",
				importer: () => import("./flow-EwtUzr2Q.js")
			}] },
			oxc: { load: [{
	...
	defineTransform({
		...
		load: [{
			...
			importer: () => import("./plugin-ftCrlgi_.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))
		}],
		parsers: { svelte: {} },
		printers: { "svelte-ast": {} },
